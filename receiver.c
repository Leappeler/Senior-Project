...
/*
 * Jacob A Turcotte & Samuel Wallace
 *
 * Arduino listens to serial connection for '0', '1', or '2'. Arduino opens/closes
 * relays and creates a path for input signal through the device based on input.
 */
...
/* Declare Variables */
int a = 8;          	/* Pin for Tremolo AKA TREMOLO */
int b = 10;          	/* Pin for Clean   AKA FLANGE */
int c = 12;          	/* Pin for Flange  AKA CLEAN */
